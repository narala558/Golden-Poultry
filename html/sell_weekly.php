...
$query = "SELECT * FROM sell_existing where ID =  (select max(ID) from sell_existing where customerName='$customerName' AND dcdate < '$fromdate' )";
...
$sql = "SELECT * FROM sell_existing WHERE customerName='$customerName' AND dcdate BETWEEN '$fromdate' AND '$todate'";

echo "<h2 >$customerName </h2>";

//$sql = "SELECT companyName, dcdate, dcnum FROM buy_existing WHERE companyName='$companyName' OR dcdate='$dcdate'";
