...
$query = "SELECT * FROM buy_existing where ID =  (select max(ID) from buy_existing where dcdate < '$fromdate')";
...
$sql="(SELECT * FROM buy_existing WHERE dcdate BETWEEN '$fromdate' AND '$todate')";
