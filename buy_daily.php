...
$sql="(SELECT companyName, dcdate, dcnum, vehicle_no, driver_name, farmer_name, farmer_address, no_cages, no_birds, total_weight, rate, amount  FROM buy_existing WHERE companyName ='$companyName' AND dcdate='$dcdate' )";

}
else{
$sql="(SELECT companyName, dcdate, dcnum, vehicle_no, driver_name, farmer_name, farmer_address, no_cages, no_birds, total_weight, rate, amount  FROM buy_existing WHERE dcdate='$dcdate')";
}



/*
$sql = "select case when companyName='$companyName' and dcdate='$dcdate' then companyName
 else then dcdate end as res,dcdate,dcnum,vehicle_no,driver_name,farmer_name,farmer_address,no_cages,no_birds, total_weight,rate,amount from buy_existing";
*/
